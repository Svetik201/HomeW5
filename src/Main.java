public class Main {
    public static void main(String[] args) {
        ...
        int year = 2021;
        if (year > 1584) {
            System.out.println(" Високосный год 1584 .");
            if (year % 4 == 0 && year % 100 != 0) {
                System.out.println(" Каждый четвертый год високосный , но не каждый сотый год .");
            } else if (year % 400 == 0) {
                System.out.println(" каждый четырехсотый год високосный .");
            } else {
